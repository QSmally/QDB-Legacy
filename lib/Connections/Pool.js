...
class Pool {
    ...
    /**
     * Adds a listener to this pool's events.
     * @param {Function} Message Callback function with as argument the message of the pool.
     */
    OnEvent (Message) { return this._Emitter.on("Message", Message); }
