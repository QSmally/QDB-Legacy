...
class Collection extends Map {
    ...
    /**
     * Collection - 
     * An extended JavaScript Map with additional utility methods. Optimised and rather used than native arrays.
     * @param {Array|Object} [Iterable] Optional initial values of this Collection.
     * @extends {Map}
     */
    constructor (Iterable = []) {

        super(Iterable instanceof Array ? Iterable : null);
        ...
        for (const Key in Iterable) this.set(Key, Iterable[Key]);
